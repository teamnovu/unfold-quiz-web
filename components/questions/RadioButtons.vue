  ...
  <QuestionContainer :data="data" @next="checkAnswer()">
    <div class="grid gap-3 sm:gap-5">
      <RadioButton
        ...
        class="relative min-h-[4rem] space-x-5 rounded-[4rem] bg-white bg-opacity-15 px-6 py-4 pr-12 transition-transform duration-300 ease-in-out sm:min-h-[5rem] sm:pr-16"
        @input="onInput(index)"
