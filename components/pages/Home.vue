<template>
  <div class="flex min-h-screen flex-col justify-center overflow-hidden">
    ...
    <div class="mb-14 px-9 sm:pl-28 sm:pr-40">
      <h1
        class="mb-28 text-xl font-bold text-custom-gold-light sm:mb-10 sm:text-4xl"
      >
        novu Quiz
      </h1>
      <div
      ...
      >
        ...
        <!-- START BUTTON -->
        <button
          class="flex items-center space-x-5 lg:justify-end"
          @click="$store.commit('SET_INDEX', 1)"
        >
          <span class="typo-400 text-2xl text-custom-gold-light sm:text-4xl"
            >Jetzt starten</span
          >
          <div
            class="relative h-10 w-10 shrink-0 rounded-full bg-custom-gold-light sm:h-20 sm:w-20"
          >
            <ArrowIcon
